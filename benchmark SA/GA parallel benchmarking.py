...
if __name__ == "__main__":
    ...
    with Pool(processes=os.cpu_count()-2) as pool:
        sequence_success_probabilities = pool.map(
            run_sequence,
            range(num_sequences)
        )
    ...
    np.savez(
        "geometric_results.npz",
        sequence_success_probabilities=sequence_success_probabilities,
